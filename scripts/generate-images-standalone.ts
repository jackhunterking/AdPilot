...
// All 40 businesses - Ready to generate!
...
async function main() {
  ...
  console.log(`Ready to generate ${businesses.length} professional business images...\n`);
  console.log(`Cost estimate: ~$2.00 total for all ${businesses.length} images\n`);
  
  const answer = await question('Start generation? (y/n): ');
