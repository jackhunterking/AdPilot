/**
 * Feature: AI Tool Export Bridge
 * Purpose: Provide a stable import path for the audience targeting tool used by the chat agent.
 * References:
...
export { audienceTargetingTool } from '@/tools/audience-targeting-tool';
